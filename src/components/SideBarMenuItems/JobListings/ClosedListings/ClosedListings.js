...
const ClosedListings = () => {
  ...
  const fetchClosedListings = async () => {
    try {
      setIsLoading(true);
      const loadingToast = toast.loading('Fetching closed listings...');
      
      const closedListings = await closedListingService.getClosedListings();
      setListings(closedListings.map(listing => ({
        id: listing.id,
        ...
        expiryDate: listing.expiryAt || 'N/A',
        ...
        assignmentLinks: listing.assignmentLink,
        date: listing.date
      })));
  ...
  return (
    <div className="job-listings-container">
      ...
      <div className="flex justify-between items-center mb4">
        <h1 className="f2 fw6 white-90">Closed Listings</h1>
